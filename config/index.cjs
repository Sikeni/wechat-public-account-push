...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx4be9c11b9a491765',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '601e1c3765461f2073d5dc751fcea4ee',
  ...
  USERS: [
    {
      ...
      id: 'o_6u45my-CO0Qf5VcHz_wBFgulgs',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'BtVvYT8jIEXmBT_8tCikWavMYSawLqZEwklUhgRFdSI',
      // 所在省份
      province: '安徽',
      // 所在城市
      city: '合肥',
